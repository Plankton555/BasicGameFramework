...
public abstract class AbstractGame {
	...
	/**
	 * Sets a reference to the GameController.
	 * This method will be called once by the GameController.
	 * @param controller
	 */
	public abstract void setGameController(GameController controller);
	
	/**
	 * Returns the game view. That is, the GameView to be updated in the game loop.
	 * @return The GameView to be updated in the game loop.
	 */
	public abstract GameView getGameView();
	
	/**
	 * Returns the main game panel. That is, the JPanel that will be placed in the window frame.
	 ...
	 * @param clientBounds The size of the game window.
	 */
